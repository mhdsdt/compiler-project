...
def get_default_dfa():
    ...
    digit_start_edge = RegexEdge(TokenType.Num.value).accept_digits()
    digit_middle_edge = RegexEdge(TokenType.Num.value).accept_digits()
    digit_final_edge = RegexEdge(TokenType.Num.value).accept_white_spaces().accept_symbols().accept_comments()
    ...
    id_keyword_start_edge = RegexEdge(TokenType.KeywordId.value).accept_alphabets()
    id_keyword_middle_edge = RegexEdge(TokenType.KeywordId.value).accept_digits().accept_alphabets()
    id_keyword_final_edge = RegexEdge(TokenType.KeywordId.value).accept_symbols().accept_comments().accept_white_spaces()
    ...
    symbol_start_edge_without_equals = RegexEdge(TokenType.Symbol.value).accept_symbols().reject('=')
    equals_edge = RegexEdge(TokenType.Symbol.value).accept('=')
    equals_edge_finisher = RegexEdge(TokenType.Symbol.value).accept_digits().accept_white_spaces().accept_comments().accept_alphabets()
    ...
    white_space_start_edge = RegexEdge(TokenType.Whitespace.value).accept_white_spaces()
    ...
    comment_start_edge = RegexEdge(TokenType.Comment.value).accept('/')
    comment_second_edge = RegexEdge(TokenType.Comment.value).accept('*')
    comment_middle_edge = RegexEdge(TokenType.Comment.value).accept_digits().accept_alphabets().accept_symbols().accept_white_spaces()
    comment_2_pre_final_edge = RegexEdge(TokenType.Comment.value).accept('*')
    comment_pre_final_edge = RegexEdge(TokenType.Comment.value).accept('/')
    ...
    comment_second_dfa.add_next_node(edge=comment_middle_edge, next_node=comment_second_dfa)
    ...
    comment_2_pre_final_dfa.add_next_node(edge=comment_middle_edge, next_node=comment_second_dfa)
    comment_2_pre_final_dfa.add_next_node(edge=comment_pre_final_edge, next_node=comment_pre_final_dfa)
